...
As an
[Apache 2.0 open source project](https://github.com/netbrah/apex?tab=Apache-2.0-1-ov-file#readme),
we appreciate and welcome
[public contributions](https://github.com/netbrah/apex/blob/main/CONTRIBUTING.md),
...
[opening an issue for discussion](https://github.com/netbrah/apex/issues/new/choose).
...
Roadmap Issue [here](https://github.com/netbrah/apex/issues/4191).
...
you can find our
[Community Guidelines here](https://github.com/netbrah/apex/blob/main/CONTRIBUTING.md)
to learn how to get started. There are many ways to get involved:

- **Roadmap:** Please review and find areas in our
  [roadmap](https://github.com/netbrah/apex/issues/4191) that you
...
- **Report Bugs:** If you find an issue, please create a
  [bug](https://github.com/netbrah/apex/issues/new?template=bug_report.yml)
...
- **Suggest Features:** Have a great idea? We'd love to hear it! Open a
  [feature request](https://github.com/netbrah/apex/issues/new?template=feature_request.yml).
- **Contribute Code:** Check out our
  [CONTRIBUTING.md](https://github.com/netbrah/apex/blob/main/CONTRIBUTING.md)
