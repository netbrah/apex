...
- **[Memory Import Processor](../reference/memport.md):** Documentation for the
  modular APEX.md import feature using @file.md syntax.
...
- **Prompt engineering:** Constructing effective prompts for the Gemini model,
  ...
  instructional context from `APEX.md` files.
...
`APEX.md` files that provide context to the model. It searches for these files
...
and `refresh` the content of loaded `APEX.md` files.
