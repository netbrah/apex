...
| Mode         | Description                                                                                                                                                                                 |
| :----------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `persistent` | **(Default)** Launches Chrome with a persistent profile stored at `~/.apex/cli-browser-profile/`. Cookies, history, and settings are preserved between sessions.                          |
...
1.  **Project-level:** `.apex/agents/*.md` (Shared with your team)
2.  **User-level:** `~/.apex/agents/*.md` (Personal agents)
...
**Example: `.apex/agents/security-auditor.md`**
