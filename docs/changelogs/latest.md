...
- fix(patch): cherry-pick 055ff92 to release/v0.36.0-preview.0-pr-23672 to patch
  ...
  @gemini-cli-robot in
  [#23723](https://github.com/netbrah/apex/pull/23723)
- fix(patch): cherry-pick 765fb67 to release/v0.36.0-preview.5-pr-24055 to patch
  ...
  @gemini-cli-robot in
  [#24061](https://github.com/netbrah/apex/pull/24061)

**Full Changelog**:
https://github.com/netbrah/apex/compare/v0.35.3...v0.36.0
