...
The
[Evals: Nightly](https://github.com/netbrah/apex/actions/workflows/evals-nightly.yml)
...
- **CI Evals**: Included in the
  [E2E (Chained)](https://github.com/netbrah/apex/actions/workflows/chained_e2e.yml)
