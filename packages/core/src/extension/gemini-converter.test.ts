...
describe('convertGeminiToApexConfig', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should convert basic Gemini config from directory', () => {
    ...
    const result = convertGeminiToApexConfig(mockDir);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertGeminiToApexConfig(mockDir)).toThrow(
