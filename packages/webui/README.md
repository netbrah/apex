...
A shared React component library for APEX applications, providing cross-platform UI components with consistent styling and behavior.
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@apex/webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@apex/webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
...
```tsx
import { Button, Input, Tooltip } from '@apex/webui';
import { PlatformProvider } from '@apex/webui/context';
...
```tsx
import { Tooltip } from '@apex/webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@apex/webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@apex/webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@apex/webui/tailwind.preset.cjs')],
  // your customizations
};
```
