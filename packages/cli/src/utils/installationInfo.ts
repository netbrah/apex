...
import { debugLogger, isGitRepository } from '@apex-code/apex-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @apex-code/apex@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @apex-code/apex@latest';
    return {
