...
import { IdeClient } from '@apex-code/apex-core';
...
describe('systemInfo', () => {
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@apex-code/apex-core');
