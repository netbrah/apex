  ...
  return [
    {
      ...
      description: t('Checked in at .apex/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.apex/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
