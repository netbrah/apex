...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .apexignore files in context (/settings)…',
  ...
  'Create a project-specific APEX.md file with /init',
  ...
  'Reload instructional context from APEX.md files with /memory reload',
  'List the paths of the APEX.md files in use with /memory list',
