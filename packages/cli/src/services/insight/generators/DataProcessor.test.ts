...
import type { Config, ChatRecord } from '@apex-code/apex-core';
import type {
  InsightData,
  SessionFacets,
...
vi.mock('@apex-code/apex-core', async () => {
  const actual = await vi.importActual<typeof import('@apex-code/apex-core')>(
    '@apex-code/apex-core',
  );
  return {
    ...actual,
...
import { read as readJsonlFile } from '@apex-code/apex-core';
    ...
    it('should aggregate satisfaction counts', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          APEX_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          APEX_helpfulness: 'slightly_helpful',
