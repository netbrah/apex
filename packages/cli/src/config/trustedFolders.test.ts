...
import { FatalConfigError, ideContextStore } from '@apex-code/apex-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use APEX_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['APEX_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['APEX_TRUSTED_FOLDERS_PATH'];
  });
