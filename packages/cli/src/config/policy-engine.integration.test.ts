    ...
    describe.each(['write_file', 'replace'])(
      ...
      (toolName) => {
        it(`should allow ${toolName} to plans directory`, async () => {
          ...
          const validPaths = [
            '/home/user/.apex/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/session-1/plans/my-plan.md',
        ...
        it(`should deny ${toolName} outside plans directory`, async () => {
          ...
          const invalidPaths = [
            ...
            '/home/user/.apex/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/script.js', // Wrong extension
            '/home/user/.apex/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/../../../etc/passwd.md', // Path traversal (Unix)
            'C:\\Users\\user\\.gemini\\tmp\\id\\session\\plans\\..\\..\\..\\Windows\\System32\\config\\SAM', // Path traversal (Windows)
            '/home/user/.apex/non-tmp/new-temp_dir_123/plans/plan.md', // outside of temp dir
          ];
